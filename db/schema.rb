...
ActiveRecord::Schema[7.0].define(version: 2023_10_12_184359) do
  ...
  create_table "property_for_rents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["properties_id"], name: "index_property_for_rents_on_properties_id"
  end
  ...
  create_table "property_for_sales", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["properties_id"], name: "index_property_for_sales_on_properties_id"
  end
  ...
  create_table "user_property_rents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_for_rent_id"], name: "index_user_property_rents_on_property_for_rent_id"
  ...
  create_table "user_property_sales", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_for_sale_id"], name: "index_user_property_sales_on_property_for_sale_id"
  ...
  add_foreign_key "property_for_rents", "properties", column: "properties_id"
  add_foreign_key "property_for_sales", "properties", column: "properties_id"
  add_foreign_key "property_users", "properties"
  add_foreign_key "property_users", "users"
  add_foreign_key "user_property_rents", "property_for_rents"
  add_foreign_key "user_property_rents", "users"
  add_foreign_key "user_property_sales", "property_for_sales"
